...
export const UploadPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Upload Card */}
      <Card title={t.upload.step1Title}>
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="font-semibold text-blue-900 mb-2">{t.upload.howToGetData}</h3>
          ...
          <div className="border-t pt-4">
            <FileUpload
              ...
              accept=".json"
              label={t.upload.jsonFileLabel}
              helperText={t.upload.jsonFileHelper}
            />
          </div>
        </div>
      </Card>
